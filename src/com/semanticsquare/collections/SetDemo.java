...
public class SetDemo {
	...
	/*@param Linked Hash Set
	 * below class
	 * hasCode and equal needed to compare 2 object
	...
	/* @param TreeSet Demo
	 * for sorting element
	 * to arrange in order CompsreTo and comparable is used
	 */
	private static void treeSetDemo() {
		...
		Set<Book> books = new TreeSet<>(new TitleComparator()); // we can pass other like authorcomparator etc but without new TitleComparator() it usese CompreTo method
		books.add(book1);
		books.add(book2);
		books.add(book3);
		books.add(book4);
	...
	private static void treeSetDemoNavigable() {
